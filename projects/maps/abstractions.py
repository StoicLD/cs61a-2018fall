...
def restaurant_price(restaurant):
    ...
    # BEGIN Question 2
    "*** YOUR CODE HERE ***"
    assert(type(restaurant[3])==float or type(restaurant[3])==int)
    return restaurant[3]
    # END Question 2
